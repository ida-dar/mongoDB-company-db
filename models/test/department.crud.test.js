...
describe('Department', () => {
  ...
  describe('Creating data', () => {
    ...
    it('should insert new document with "insertOne" method', async () => {
      ...
      expect(department.isNew).to.be.false; // if the document wasn't svaed to DB 'isNew' = true, if it was, 'isNew' = false
    });
  ...
  describe('Updating data', () => {
    ...
    it('should properly update one document with "save" method', async () => { // this case has to be tested too, 'cause mongoose encourages to use 'save' method for updating one document instead of 'updateOne'
      const department = await Department.findOne({ name: 'Department #1' });
  ...
  describe('Removing data', () => {
    ...
    it('should properly remove multiple documents with "deleteMany" method', async () => {
      await Department.deleteMany({});
      const removed = await Department.find();
